...
const appointmentComplete = async (req,res) => {
   try {
      ...
      console.log("From request body: docId =", docId);
      if (appointmentData && appointmentData.docId && docId === docId.toString()) {
...
const doctorProfile = async (req,res) => {
   ...
   //   const {docId} = req.body
     const docId = req.doctor.id
     const profileData = await doctorModel.findById(req.doctor.id).select('-password')
...
const updateDoctorProfile = async (req, res) => {
   ...
   try {
      ...
      await doctorModel.findByIdAndUpdate(req.doctor.id, {fees, address, available})
