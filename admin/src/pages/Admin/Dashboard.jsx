  ...
  return dashData && (
    <div className='m-5'>
      ...
      <div className='flex flex-wrap gap-3'>
        ...
        <div className='flex items-center gap-2 bg-gray-700 p-4 min-w-52 rounded border-2 border-gray-200 text-white cursor-pointer hover:scale-105 transition-all'>
